...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2019 at 06:52 PM
...
INSERT INTO `admission` (`a_student_id`, `a_student_currentdate`, `a_student_faculty`, `a_student_adm_fees`, `a_student_monthly_fees`, `a_student_department`, `a_student_class`, `a_student_duedate`, `a_student_registration_id`, `a_student_batch_code`, `user_id`, `trash_status`, `a_payment`) VALUES
(1, '2019-07-28', 1, 4000, 1000, 5, 8, '2019-08-29', 1, '324ioewj', 1, 'restored', 'paid'),
(2, '2019-07-29', 1, 4000, 2000, 5, 8, '2019-08-29', 2, '324ioewj', 1, 'restored', 'paid but remaining');
...
(1, 'Aliyan', 'http://[::1]/lead_in/uploads/faculty_signature/Desert1.jpg', 'restored', 'Paid');
...
INSERT INTO `fee_form` (`fee_id`, `student_name`, `admission_id`, `total_fee`, `pending_fee`, `date`, `time`, `remarks`, `other_fee`, `certification_fee`, `late_fee`, `notes_fee`) VALUES
(1, 'Ali', 1, 5000, 0, '2019-06-28', '07:29:32', '', 0, 0, 0, 0),
(2, 'safder', 2, 4000, 2000, '2019-07-28', '10:35:40', '', 0, 0, 0, 0);
...
(6, 4, '2019-07-27', '09:46:00', 'Interested'),
(7, 4, '2019-07-27', '09:54:33', 'not interested'),
(8, 4, '2019-07-27', '01:05:19', 'not interested!'),
(9, 1, '2019-07-28', '12:48:41', 'Interested'),
(10, 1, '2019-07-28', '12:48:50', 'Interested'),
(11, 1, '2019-07-28', '12:50:58', 'Interested.');
...
(1, '2019-07-28', 'Abdul Qadir', 'Shoukat', 2147483647, 3000, 2000, 2, 8, 9, 7, 'Interested.', 'restored', NULL),
(2, '2019-07-28', 'Muhammad Zubair', 'Tariq', 3340031928, 500, 5000, 1, 8, 9, 5, 'Interested', 'restored', NULL);
...
(1, '30', '2019-07-29', 'Not Complete', '', 'restored');
...
(1, 'Ali', 'Hussain', 234234234, 234234234, 234234234, 23423423423, '2019-07-30', 'Male', 'http://[::1]/lead_in/uploads/1564408865.png', 'Single', 234234234, 'Pakistani', 1, 1, 1, '', '2019-07-29', 'restored'),
(2, 'safder', 'mustaq', 3342431026, 3342431026, 3342431026, 3342431026, '2019-07-01', 'Male', 'http://[::1]/lead_in/uploads/1564421477.png', 'Single', 0, 'Pakistani', 0, 1, 1, '', '2019-07-29', 'restored');
...
(1, 21, 'Hi', '2019-07-29', '05:02:28', 'pending');
...
(21, 'Ahmed', 'ah@mail.com', '123', 'editor', 'http://\r\n\r\n[::1]/lead_in/uploads/Lighthouse5.jpg', 'Senior Teacher', '16:00:00', '21:00:00', 1),
...
(25, 'Developer', 'dev@mail.com', '123', 'editor', 'http://[::1]/lead_in/uploads/Penguins6.jpg', 'Developer', '16:00:00', '21:00:00', 0);
...
--
ALTER TABLE `admission`
  MODIFY `a_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `monthlytarget`
  MODIFY `m_target_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `target_chase`
  MODIFY `chase_id` int(11) NOT NULL AUTO_INCREMENT;
--
