...
?>
    ...
    <div class="box">
              ...
              <div class="box-header">
                <h3 class="box-title"><a href="<?php echo base_url('Welcome/salary/add') ?>" class="btn bg-red btn-flat">Add New Salary</a> <a href="<?php echo base_url('Welcome/salary/viewTrash') ?>" class="btn bg-maroon btn-flat">Trash <i class="fa fa-trash"></i></a></h3>
